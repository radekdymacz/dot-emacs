...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(isearch                                  ((,class (:normal t :foreground ,accent :background ,bg4))))
   ...
   `(mode-line                                ((,class (:normal nil :foreground ,fg1 :background "#237AD3"))))
   `(mode-line-inactive                       ((,class (:normal nil :foreground ,fg2 :background "#237AD3"))))
   ...
   `(org-level-1                              ((,class (:normal t :foreground ,keyword :height 1.1))))
   `(org-level-2                              ((,class (:normal nil :foreground ,func))))
   `(org-level-3                              ((,class (:normal t :foreground ,keyword))))
   `(org-level-4                              ((,class (:normal nil :foreground ,var))))
